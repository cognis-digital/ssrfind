"""SSRFIND core — Find SSRF-prone sinks and unvalidated URL fetches in code."""
...
RULES = [
    ("SSR-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SSR-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SSR-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
