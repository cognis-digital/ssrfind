#!/usr/bin/env sh
# Universal installer for ssrfind. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ssrfind.git"
echo "Installing ssrfind ..."
